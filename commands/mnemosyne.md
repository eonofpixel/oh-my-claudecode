...
Mnemosyne (named after the Greek goddess of memory) extracts REUSABLE SKILLS - not just code snippets to copy-paste, but **principles and decision-making heuristics** that teach Claude HOW TO THINK about a class of problems.
...
4. **Save Location**:
   - **User-level**: ~/.claude/skills/sisyphus-learned/ - Rare. Only for truly portable insights.
   - **Project-level**: .sisyphus/skills/ - Default. Version-controlled with repo.
